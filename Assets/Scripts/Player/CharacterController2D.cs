...
public class CharacterController2D : MonoBehaviour
{
	...
	[SerializeField] private float m_WallKickback = 300f;
	[SerializeField] private float m_WallSlideSpeed = 100f;
	...
	private bool m_IsTouchingFront;     // If there is a wall in front of the player
	...
	private void FixedUpdate()
	{
		...
		m_IsTouchingFront = Physics2D.OverlapCircle(m_WallCheck.position, k_WallRadius, m_WhatIsGround);
	}
	...
	public void Move(float move, bool crouch, bool jump)
	{
		...
		else if (!m_Grounded && m_IsTouchingFront && jump && move != 0)
		{
			...
			m_Rigidbody2D.velocity = new Vector2(move*-1*m_WallKickback, m_JumpForce*0.015f);
		}
		
		//If the character is facing the wall while holding towards it and
		else if (move != 0 && m_IsTouchingFront && !m_Grounded)
		{
